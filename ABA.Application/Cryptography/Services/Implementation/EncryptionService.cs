...
using ABA.Application.Cryptography.Providers;

namespace ABA.Application.Cryptography.Services.Implementation
{
    public class EncryptionService: IEncryptionService
    {
        internal const int InitializationVectorSize = 16;
        internal const CipherMode BlockCipherMode = CipherMode.CBC;
        const string Password = "Crack this";
        ...
        {
            return Encrypt(Encoding.UTF8.GetBytes(plaintext), Password, KeySize.Aes128);
        }
        ...
        {
            return Decrypt(Convert.FromBase64String(ciphertext), Password, KeySize.Aes128);
        }
